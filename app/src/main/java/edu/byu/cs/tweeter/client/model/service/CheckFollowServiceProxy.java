...
public class CheckFollowServiceProxy implements CheckFollowService {

    private static final String URL_PATH = "/checkfollow";

    private final ServerFacade serverFacade = new ServerFacade();

    @Override
    public CheckFollowResponse checkFollow(CheckFollowRequest request) throws IOException {
        return serverFacade.checkFollow(request, URL_PATH);
    }
}
